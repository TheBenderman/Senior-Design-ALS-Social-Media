...
public class TwitterHomeTest : UITest
{
    ...
    {
		#if UNITY_EDITOR
            yield return LoadSceneByPath("Assets/UITest/TwitterUI/TestableTwitterScene.unity");
        #endif
    ...
    [UITest]
    public IEnumerable PressTweetShowsKeyboard()
    {
